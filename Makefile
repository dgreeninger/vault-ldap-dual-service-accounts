...
help:
	...
	@echo "  6. make create-appuser-role  # Create static role for appuser"
	@echo "  7. make get-role-creds ROLE=appuser  # Get credentials"
	@echo "  8. make rotate-role ROLE=appuser     # Rotate the password"
	@echo ""
